        ...
        describe(`new ExifTool(${JSON.stringify(opts)})`, () => {
            ...
            describe("argument-injection hardening", () => {
                it("rejects inputFile containing a newline (defense-in-depth)", async () => {
                    return (0, _chai_spec_1.expect)(exiftool.rewriteAllTags("input.jpg\n-o\n../exploit", "ignored.jpg")).to.be.rejectedWith(/control character/);
                });
                it("rejects outputFile containing a newline (defense-in-depth)", async () => {
                    const img = await (0, _chai_spec_1.testImg)();
                    return (0, _chai_spec_1.expect)(exiftool.rewriteAllTags(img, "out.jpg\n-o\n../exploit")).to.be.rejectedWith(/control character/);
                });
            });
        });
    }
