...
describe("BinaryExtractionTask", () => {
    ...
    it("rejects argument-injection via tagname", async () => {
        const src = node_path_1.default.join(_chai_spec_1.testDir, "with_thumb.jpg");
        const dest = (0, _chai_spec_1.tmpname)();
        return (0, _chai_spec_1.expect)(ExifTool_1.exiftool.extractBinaryTag("ThumbnailImage\n-o\n../thumb-exploit", src, dest)).to.be.rejectedWith(/Invalid tag name|control character/);
    });
});
